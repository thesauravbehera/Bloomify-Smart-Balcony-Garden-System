...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden max-h-[90vh] overflow-y-auto glass-strong border-2 border-primary/30">
        {/* Decorative Header */}
        <div className="relative h-28 bg-gradient-to-br from-primary via-secondary to-accent overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
            <motion.div
              ...
              className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center glow-green"
            >
        ...
        <div className="px-6 pb-6 pt-4">
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "login" | "signup")} className="w-full">
            ...
            <TabsList className="grid w-full grid-cols-2 mb-6 glass p-1 rounded-xl border border-primary/20">
              <TabsTrigger 
                value="login" 
                className="rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg transition-all"
              >
                Login
              </TabsTrigger>
              <TabsTrigger 
            ...
            <TabsContent value="login" className="mt-0">
              <DialogHeader className="mb-6">
                ...
                <DialogDescription className="text-center">
                  Login to continue your gardening journey
                </DialogDescription>
              </DialogHeader>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-11 glass-light border-primary/20 focus:border-primary/50 text-foreground"
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-11 pr-10 glass-light border-primary/20 focus:border-primary/50 text-foreground"
                      required
                    />
                    <button
                      type="button"
                ...
                <Button type="submit" className="w-full h-11 btn-cosmic glow-hover" disabled={isLoading}>
                  {isLoading ? (
                    <motion.div
                      animate={{ rotate: 360 }}
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  ...
                  className="h-11 glass-light border-primary/20 hover:border-primary/50 hover:bg-primary/10"
                >
            ...
            <TabsContent value="signup" className="mt-0">
              <DialogHeader className="mb-6">
                <DialogTitle className="text-center text-2xl">Join Bloomify</DialogTitle>
                <DialogDescription className="text-center">
                  Create an account to start your balcony garden
                </DialogDescription>
              </DialogHeader>
